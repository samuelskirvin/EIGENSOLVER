...
for i in range(len(sol_ks1e5)):
    if sol_ks1e5[i] > 2.725 and sol_ks1e5[i] < 2.775:
      if sol_omegas1e5[i]/sol_ks1e5[i] > 2.:
...
for i in range(len(sol_ks_kink1e5)):
    #if sol_ks_kink1e5[i] > 1.25 and sol_ks_kink1e5[i] < 1.275:
    if sol_ks_kink1e5[i] > 2.75 and sol_ks_kink1e5[i] < 3.05:         
       if sol_omegas_kink1e5[i]/sol_ks_kink1e5[i] > 2. and sol_omegas_kink1e5[i]/sol_ks_kink1e5[i] < 3.4:
         sol_ks1e5_singleplot_fast_kink.append(sol_ks_kink1e5[i])
         sol_omegas1e5_singleplot_fast_kink.append(sol_omegas_kink1e5[i])        
 
       elif sol_omegas_kink1e5[i]/sol_ks_kink1e5[i] < 1.2: 
...
for i in range(len(sol_ks3)):
    if sol_ks3[i] > 2.725 and sol_ks3[i] < 2.775:
      if sol_omegas3[i]/sol_ks3[i] > 2.:
...
for i in range(len(sol_ks_kink3)):
    #if sol_ks_kink3[i] > 1.25 and sol_ks_kink3[i] < 1.275:
    if sol_ks_kink3[i] > 2.85 and sol_ks_kink3[i] < 3.05:       
       if sol_omegas_kink3[i]/sol_ks_kink3[i] > 2. and sol_omegas_kink3[i]/sol_ks_kink3[i] < 3.4:
         sol_ks3_singleplot_fast_kink.append(sol_ks_kink3[i])
         sol_omegas3_singleplot_fast_kink.append(sol_omegas_kink3[i])        
 
       elif sol_omegas_kink3[i]/sol_ks_kink3[i] < 1.2: 
...
for i in range(len(sol_ks15)):
    if sol_ks15[i] > 2.725 and sol_ks15[i] < 2.775:
      if sol_omegas15[i]/sol_ks15[i] > 2.:
...
for i in range(len(sol_ks_kink15)):
    #if sol_ks_kink15[i] > 1.25 and sol_ks_kink15[i] < 1.275:  
    if sol_ks_kink15[i] > 2.75 and sol_ks_kink15[i] < 3.05:       
       if sol_omegas_kink15[i]/sol_ks_kink15[i] > 2. and sol_omegas_kink15[i]/sol_ks_kink15[i] < 3.4:
         sol_ks15_singleplot_fast_kink.append(sol_ks_kink15[i])
         sol_omegas15_singleplot_fast_kink.append(sol_omegas_kink15[i])        
 
       elif sol_omegas_kink15[i]/sol_ks_kink15[i] < 1.2: 
...
for i in range(len(sol_ks09)):
    if sol_ks09[i] > 2.725 and sol_ks09[i] < 2.775:
      if sol_omegas09[i]/sol_ks09[i] > 2.:
...
for i in range(len(sol_ks_kink09)):
    #if sol_ks_kink09[i] > 1.25 and sol_ks_kink09[i] < 1.275: 
    if sol_ks_kink09[i] > 2.75 and sol_ks_kink09[i] < 3.05:        
       if sol_omegas_kink09[i]/sol_ks_kink09[i] > 2. and sol_omegas_kink09[i]/sol_ks_kink09[i] < 3.4:
...
P0 = [1e-8, 1e-15]   #Initial conditions of vx(0), vx'(0)  assume much much less than one at infinity
...
#plt.savefig("coronal_density_fund_kink_eigenfunctions_k13.png")
#plt.savefig("coronal_density_fast_sausage_eigenfunctions_k27.png")
