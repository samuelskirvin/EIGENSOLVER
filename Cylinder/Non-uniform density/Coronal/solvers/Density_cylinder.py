...
wavenumber = np.linspace(0.01,4.5,90)    #101
...
if __name__ == '__main__':
    ...
    for k in wavenumber:
      for i in range(len(speeds)-1):
         ...
         test_freq = np.linspace(speeds[i]*k, speeds[i+1]*k, 90.)   #was 60
...
with open('Cylindrical_coronal_width095.pickle', 'wb') as f:     # EXPORT SOLUTIONS TO A PICKLE FILE
...
plt.savefig("cylinder_dispersion_diagram_coronal_095.png")
