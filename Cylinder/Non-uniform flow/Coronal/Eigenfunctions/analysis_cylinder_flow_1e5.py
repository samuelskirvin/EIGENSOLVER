...
for i in range(len(sol_ks1e5)):   #sausage mode
  v_phase = sol_omegas1e5[i]/sol_ks1e5[i]
      
  if v_phase > vA_i0 and v_phase < vA_e:  
      fast_body_sausage_omega.append(sol_omegas1e5[i])
      fast_body_sausage_k.append(sol_ks1e5[i])
      
  if v_phase > cT_i0+U_i0 and v_phase < c_i0+U_i0:  
      slow_body_sausage_omega.append(sol_omegas1e5[i])
      slow_body_sausage_k.append(sol_ks1e5[i])

  if v_phase < -cT_i0 and v_phase > -c_i0 + U_i0: 
      slow_backward_body_sausage_omega.append(sol_omegas1e5[i])
      slow_backward_body_sausage_k.append(sol_ks1e5[i])

  if v_phase > -vA_e and v_phase < -vA_i0:
      slow_fast_body_sausage_omega.append(sol_omegas1e5[i])
      slow_fast_body_sausage_k.append(sol_ks1e5[i])
            
  else:
      new_modes_sausage_k.append(sol_ks1e5[i])
      new_modes_sausage_omega.append(sol_omegas1e5[i])
      



for i in range(len(sol_ks_kink1e5)):   #kink mode
  v_phase = sol_omegas_kink1e5[i]/sol_ks_kink1e5[i]
      
  if v_phase > vA_i0 and v_phase < vA_e: 
      fast_body_kink_omega.append(sol_omegas_kink1e5[i])
      fast_body_kink_k.append(sol_ks_kink1e5[i])
            
  if v_phase > cT_i0+U_i0 and v_phase < c_i0: 
      slow_body_kink_omega.append(sol_omegas_kink1e5[i])
      slow_body_kink_k.append(sol_ks_kink1e5[i])

  if v_phase < -cT_i0 and v_phase > -c_i0+U_i0:
      slow_backward_body_kink_omega.append(sol_omegas_kink1e5[i])
      slow_backward_body_kink_k.append(sol_ks_kink1e5[i])

  if v_phase > -vA_e and v_phase < -vA_i0:
      slow_fast_body_kink_omega.append(sol_omegas_kink1e5[i])
      slow_fast_body_kink_k.append(sol_ks_kink1e5[i])
            
  else:
      new_modes_kink_k.append(sol_ks_kink1e5[i])
      new_modes_kink_omega.append(sol_omegas_kink1e5[i])
...
if len(fast_sausage_branch1_omega) > 1:
  ...
  k_new = np.linspace(2.8, FSB1_k[-1], num=len(FSB1_k)*10)
...
if len(fast_kink_branch1_omega) > 1:
  ...
  k_kink_new = np.linspace(2., FSB1_kink_k[-1], num=len(FSB1_kink_k)*10)   #FSB1_kink_k[-1]
...
slow_body_sausage_branch1_omega = [0.05*(cT_i0+U_i0), 0.1*(cT_i0+U_i0)]
slow_body_sausage_branch1_k = [0.05, 0.1]
...
for i in range(len(slow_body_sausage_omega)):   #sausage mode
  ...
  if v_phase > cT_i0+U_i0 and v_phase < c_i0 and slow_body_sausage_k[i] < 1.9:
...
slow_body_kink_branch1_omega = [0.1*(cT_i0+U_i0)]
slow_body_kink_branch1_k = [0.1]
...
if len(slow_body_sausage_branch1_omega) > 1:
  ...
  sb_k_new = np.linspace(sb_k[-1], 1.87, num=len(sb_k)*10)  #FSB2_k[-1]
...
if len(slow_body_kink_branch1_omega) > 1:
  ...
  sbk_k_new = np.linspace(0., 3.8, num=len(sbk_k)*10)  #SBk_k[-1]
...
ax.plot(sol_ks1e5, (sol_omegas1e5), 'r.', markersize=4.)
ax.plot(sol_ks_kink1e5, (sol_omegas_kink1e5), 'b.', markersize=4.)
...
#ax2.plot(sol_ks1e5, (sol_omegas1e5/sol_ks1e5), 'r.', markersize=4.)
...
#ax2.annotate( ' $c_{i}+U_{B}$', xy=(Kmax, c_i0+flow_bound), fontsize=12)
#ax2.annotate( ' $c_{Ti}+U_{B}$', xy=(Kmax, cT_i0+flow_bound), fontsize=12)
...
plt.savefig("cylinder_flow_width1e5_coronal_curves_ZOOM.png")
...
for i in range(len(sol_ks_kink1e5)):
    ...
    if sol_ks_kink1e5[i] > 1.02 and sol_ks_kink1e5[i] < 1.1:         
...
ax.plot(sol_ks1e5_singleplot_slow[0], (sol_omegas1e5_singleplot_slow[0]/sol_ks1e5_singleplot_slow[0]), 'k.', markersize=10.)
...
plt.savefig("flow_width1e5_slow_sausage_eigenfunctions.png")
