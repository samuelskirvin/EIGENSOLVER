...
for i in range(len(sol_ks_kink_v01_p08)):
    if (sol_omegas_kink_v01_p08[i]/sol_ks_kink_v01_p08[i]) < (cT_i0+((0.1*(0.002**(alpha-1)))/(sol_ks_kink_v01_p08[i]))):
       Omega_slow_kink_w.append(sol_omegas_kink_v01_p08[i])
       Omega_slow_kink_k.append(sol_ks_kink_v01_p08[i])
       
    if (sol_omegas_kink_v01_p08[i]/sol_ks_kink_v01_p08[i]) > (cT_i0+((0.1*(0.002**(alpha-1)))/(sol_ks_kink_v01_p08[i]))):
       Omega_fast_kink_w.append(sol_omegas_kink_v01_p08[i])
       Omega_fast_kink_k.append(sol_ks_kink_v01_p08[i])
...
wavenum = Omega_slow_kink_k[::-1]
frequency = Omega_slow_kink_w[::-1]
...
ax.set_title(r'$\propto 0.1*r^{0.8}$')
ax.set_xlabel("$ka$", fontsize=16)
ax.set_ylabel(r'$\frac{\omega}{k}$', fontsize=22, rotation=0, labelpad=15)
ax.set_xlim(0., 4.)  
ax.set_ylim(0.85, c_e+0.01)  
...
ax.plot(sol_ks_kink_v01_p08, (sol_omegas_kink_v01_p08)/sol_ks_kink_v01_p08, 'b.', markersize=4.)

#ax.plot(Omega_fast_kink_k, (Omega_fast_kink_w)/Omega_fast_kink_k, 'bx', markersize=6.)
#ax.plot(Omega_slow_kink_k, (Omega_slow_kink_w)/Omega_slow_kink_k, 'rx', markersize=6.)
...
for i in range(len(wavenum)):
   ...
   disp_dot, = ax.plot(wavenum[i], frequency[i]/wavenum[i], 'b.', markersize=10.)
...
anim = animation.ArtistAnimation(fig, image, interval=0.1, blit=True, repeat=False).save('v01_p08_slowomega_kink_v_components.mp4', writer=writer)
