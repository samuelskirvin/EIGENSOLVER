...
for i in range(len(sol_ks_v01_p08)):   #sausage mode
  v_phase = sol_omegas_v01_p08[i]/sol_ks_v01_p08[i]
      
  if v_phase > c_kink and v_phase < c_e and sol_ks_v01_p08[i] < 3.:  
      fast_surf_sausage_omega.append(sol_omegas_v01_p08[i])
      fast_surf_sausage_k.append(sol_ks_v01_p08[i])      

  if v_phase > c_kink and v_phase < 1.4 and sol_ks_v01_p08[i] > 3.:  
      fast_surf_sausage_omega.append(sol_omegas_v01_p08[i])
      fast_surf_sausage_k.append(sol_ks_v01_p08[i])      

  if v_phase > cT_i0 and v_phase < c_i0:  
      slow_body_sausage_omega.append(sol_omegas_v01_p08[i])
      slow_body_sausage_k.append(sol_ks_v01_p08[i])

  if v_phase > 0.88 and v_phase < cT_i0:
      slow_surf_sausage_omega.append(sol_omegas_v01_p08[i])
      slow_surf_sausage_k.append(sol_ks_v01_p08[i])


amp = 0.1
alpha = 0.8
test_r = 1.
for i in range(len(sol_ks_kink_v01_p08)):   #kink mode
  v_phase = sol_omegas_kink_v01_p08[i]/sol_ks_kink_v01_p08[i]
      
  if v_phase > c_kink-0.02 and v_phase < c_e and sol_ks_kink_v01_p08[i] > 0.8 and sol_ks_kink_v01_p08[i] < 3.7:  
      fast_surf_kink_omega.append(sol_omegas_kink_v01_p08[i])
      fast_surf_kink_k.append(sol_ks_kink_v01_p08[i])

  if v_phase > c_kink-0.02 and v_phase < 1.4 and sol_ks_kink_v01_p08[i] > 3.7:  
      fast_surf_kink_omega.append(sol_omegas_kink_v01_p08[i])
      fast_surf_kink_k.append(sol_ks_kink_v01_p08[i])

  if v_phase < cT_i0+((amp*(1.**(alpha-1)))/(sol_ks_kink_v01_p08[i])) and sol_ks_kink_v01_p08[i] > 2. and v_phase < 0.94 and v_phase > 0.885:  
      slow_surf_kink_omega.append(sol_omegas_kink_v01_p08[i])
      slow_surf_kink_k.append(sol_ks_kink_v01_p08[i])

  if v_phase < cT_i0+((amp*(1.**(alpha-1)))/(sol_ks_kink_v01_p08[i])) and sol_ks_kink_v01_p08[i] < 2. and v_phase < 1.3:  
      slow_surf_kink_omega.append(sol_omegas_kink_v01_p08[i])
      slow_surf_kink_k.append(sol_ks_kink_v01_p08[i])

  if v_phase < 1.29 and sol_ks_kink_v01_p08[i] < 0.9 and v_phase > 1.:  
      slow_surf_kink_omega.append(sol_omegas_kink_v01_p08[i])
      slow_surf_kink_k.append(sol_ks_kink_v01_p08[i])

  if v_phase > cT_i0+((amp*(1.**(alpha-1)))/(sol_ks_kink_v01_p08[i])) and v_phase < 1.2:  
      slow_body_kink_omega.append(sol_omegas_kink_v01_p08[i])
      slow_body_kink_k.append(sol_ks_kink_v01_p08[i])
...
#ax.plot(sol_ks_v01_p08, (sol_omegas_v01_p08/sol_ks_v01_p08), 'r.', markersize=4.)
...
plt.savefig("v01_p08_photospheric_curves_KINKONLY.png")
plt.show()
exit()
