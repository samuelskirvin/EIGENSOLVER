...
v_twist = 0.15
power = 1.25   #0.85   ## this sets the linearity of the rotational flow  i.e. p=1 = linear, p=2 = quadratic, p=0.5 = square rooted etc.
...
speeds = [c_e, c_kink, 1.4]   #3 works 
#speeds = [-5., -4.5, -4., -3.5, -3., -2.75, -2.5]    
...
wavenumber = np.linspace(0.75,4.,110.)    #1.75 works
...
with open('Cylindrical_photospheric_vtwist015_power125_sausage_fast.pickle', 'wb') as f:     # EXPORT SOLUTIONS TO A PICKLE FILE
...
plt.savefig("Cylindrical_photospheric_vtwist015_power125_sausage_fast.png")
