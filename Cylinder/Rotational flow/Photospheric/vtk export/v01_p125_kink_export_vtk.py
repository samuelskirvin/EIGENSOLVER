...
for i in range(len(sol_ks_v001_p125)):
    ...
    if sol_ks_v001_p125[i] > 1.29 and sol_ks_v001_p125[i] < 1.45:         
       if sol_omegas_v001_p125[i]/sol_ks_v001_p125[i] > 0.905 and sol_omegas_v001_p125[i]/sol_ks_v001_p125[i] < 0.92: 
...
for i in range(len(sol_ks_kink_v001_p125)):
    if sol_ks_kink_v001_p125[i] > 0.68 and sol_ks_kink_v001_p125[i] < 0.7:        
    ...
    if sol_ks_kink_v001_p125[i] > 0.56 and sol_ks_kink_v001_p125[i] < 0.62:         
       if sol_omegas_kink_v001_p125[i]/sol_ks_kink_v001_p125[i] > cT_i0 and sol_omegas_kink_v001_p125[i]/sol_ks_kink_v001_p125[i] < c_i0: 
...
for i in range(len(sol_ks_kink_v005_p125)):
    if sol_ks_kink_v005_p125[i] > 0.68 and sol_ks_kink_v005_p125[i] < 0.7:        
    ...
    if sol_ks_kink_v005_p125[i] > 0.56 and sol_ks_kink_v005_p125[i] < 0.62:         
       if sol_omegas_kink_v005_p125[i]/sol_ks_kink_v005_p125[i] > cT_i0 and sol_omegas_kink_v005_p125[i]/sol_ks_kink_v005_p125[i] < c_i0: 
...
sol_ksv01_p125_singleplot_body_kink = []
sol_omegasv01_p125_singleplot_body_kink = []


for i in range(len(sol_ks_kink_v01_p125)):
    if sol_ks_kink_v01_p125[i] > 0.68 and sol_ks_kink_v01_p125[i] < 0.7:        
    ...
    if sol_ks_kink_v01_p125[i] > 0.56 and sol_ks_kink_v01_p125[i] < 0.62:         
       if sol_omegas_kink_v01_p125[i]/sol_ks_kink_v01_p125[i] > c_i0 and sol_omegas_kink_v01_p125[i]/sol_ks_kink_v01_p125[i] < c_kink: 
    ...
    if sol_ks_kink_v01_p125[i] > 1.65 and sol_ks_kink_v01_p125[i] < 1.7:         
       if sol_omegas_kink_v01_p125[i]/sol_ks_kink_v01_p125[i] > 0.95 and sol_omegas_kink_v01_p125[i]/sol_ks_kink_v01_p125[i] < 0.96: 
         sol_ksv01_p125_singleplot_body_kink.append(sol_ks_kink_v01_p125[i])
         sol_omegasv01_p125_singleplot_body_kink.append(sol_omegas_kink_v01_p125[i])
...
sol_ksv01_p125_singleplot_body_kink = np.array(sol_ksv01_p125_singleplot_body_kink)
sol_omegasv01_p125_singleplot_body_kink = np.array(sol_omegasv01_p125_singleplot_body_kink)
...
for i in range(len(sol_ks_kink_v015_p125)):
    if sol_ks_kink_v015_p125[i] > 0.68 and sol_ks_kink_v015_p125[i] < 0.7:        
    ...
    if sol_ks_kink_v015_p125[i] > 0.56 and sol_ks_kink_v015_p125[i] < 0.62:         
       if sol_omegas_kink_v015_p125[i]/sol_ks_kink_v015_p125[i] > c_i0 and sol_omegas_kink_v015_p125[i]/sol_ks_kink_v015_p125[i] < c_kink: 
...
for i in range(len(sol_ks_kink_v025_p125)):
    if sol_ks_kink_v025_p125[i] > 0.68 and sol_ks_kink_v025_p125[i] < 0.7:        
    ...
    if sol_ks_kink_v025_p125[i] > 0.56 and sol_ks_kink_v025_p125[i] < 0.62:         
...
ax.plot(sol_ksv01_p125_singleplot_body_kink, (sol_omegasv01_p125_singleplot_body_kink/sol_ksv01_p125_singleplot_body_kink), 'k.', markersize=15.)
...
wavenum = sol_ksv01_p125_singleplot_body_kink[0]
frequency = sol_omegasv01_p125_singleplot_body_kink[0]
...
v_x_full = np.zeros(((len(time), len(spatial), len(THETA), len(z))))
v_y_full = np.zeros(((len(time), len(spatial), len(THETA), len(z))))
  ...
  for j in range(len(THETA)):
    for i in range(len(spatial)):
      for t in range(len(time)):
        ...
        bkg_vel_x_01[i,j,k] = 10.*bkg_v_iphi_01[i]*-np.sin(thetas[i,j,k])  #v_iphi_005_np(ix)[i]*-np.sin(thetas[i,j,k])
        bkg_vel_y_01[i,j,k] = 10.*bkg_v_iphi_01[i]*np.cos(thetas[i,j,k])  #v_iphi_005_np(ix)[i]*np.cos(thetas[i,j,k]) 

        v_x_full[t,i,j,k] = v_x[t,i,j,k] + bkg_vel_x_01[i,j,k]
        v_y_full[t,i,j,k] = v_y[t,i,j,k] + bkg_vel_y_01[i,j,k]
...
varlist = ['xi_r', 'xi_phi', 'P_T', 'v_r', 'v_phi', 'xi_x', 'xi_y', 'v_x', 'v_y', 'v_z', 'full_v_x', 'full_v_y']

for t in range(len(time)):
    makeDumpVTK(x,y,z,[ xi_r[t,:,:,:], xi_phi[t,:,:,:], PT[t,:,:,:], v_r[t,:,:,:], v_phi[t,:,:,:], xi_x[t,:,:,:], xi_y[t,:,:,:], v_x[t,:,:,:], v_y[t,:,:,:], v_z[t,:,:,:], v_x_full[t,:,:,:], v_y_full[t,:,:,:]],varlist,'v01_p125_slowbody_kink_0'+ str(t))
...
def animate(i):     
   ...
   ax.set_title(' $A = 0.1  -  p = 1.25  - kink - k = 1.65$ - t = %d' %i)
   ax.plot(a,b, 'r--')
   ax2.plot(a,b, 'r--')
...
#####
   ...
   ax.scatter(boundary_point_x[:,el], boundary_point_y[:,el], s=4., c='blue')
   ax.plot(boundary_point_x[:,el], boundary_point_y[:,el])     
   ax.quiver(new_xx[::20,::20], new_yy[::20,::20], vx_interp[::20,::20], vy_interp[::20,::20], pivot='tail', color='black', scale_units='inches', scale=5., width=0.003)   # 7 scale 
...
####################################################
   ...
   ax2.scatter(boundary_point_x_full[:,el], boundary_point_y_full[:,el], s=4., c='blue')
   ax2.plot(boundary_point_x_full[:,el], boundary_point_y_full[:,el])     
   ax2.quiver(new_xx[::20,::20], new_yy[::20,::20], vx_interp_full[::20,::20], vy_interp_full[::20,::20], pivot='tail', color='black', scale_units='inches', scale=5., width=0.003)
...
anim = FuncAnimation(fig, animate, interval=100, frames=len(time)-1).save('twisted_flow_v01_p125_body_kink_vel_full_field.mp4', writer=writer)
