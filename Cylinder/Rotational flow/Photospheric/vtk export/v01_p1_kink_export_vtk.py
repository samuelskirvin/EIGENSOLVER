...
ax.plot(sol_ksv01_p1_singleplot_body_kink, (sol_omegasv01_p1_singleplot_body_kink/sol_ksv01_p1_singleplot_body_kink), 'k.', markersize=15.)
...
wavenum = sol_ksv01_p1_singleplot_body_kink[0]
frequency = sol_omegasv01_p1_singleplot_body_kink[0]
...
for t in range(len(time)):
    makeDumpVTK(x,y,z,[ xi_r[t,:,:,:], xi_phi[t,:,:,:], PT[t,:,:,:], v_r[t,:,:,:], v_phi[t,:,:,:], xi_x[t,:,:,:], xi_y[t,:,:,:], v_x[t,:,:,:], v_y[t,:,:,:], v_z[t,:,:,:], v_x_full[t,:,:,:], v_y_full[t,:,:,:]],varlist,'v01_p1_slowbody_kink_0'+ str(t))
