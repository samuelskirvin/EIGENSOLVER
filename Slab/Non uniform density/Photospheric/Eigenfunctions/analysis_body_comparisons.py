...
dx2=2. #standard dev
def profile_2(x):       # Define the internal profile as a function of variable x   (Inverted Gaussian)
    return (rho_e + ((rho_i0 - rho_e)*sym.exp(-(x-x0)**2/dx2**2)))   
profile2_np=sym.lambdify(xx,profile_2(xx),"numpy")   #In order to evaluate we need to switch to numpy
...
dx125=1.25 #standard dev
def profile_125(x):       # Define the internal profile as a function of variable x   (Inverted Gaussian)
    return (rho_e + ((rho_i0 - rho_e)*sym.exp(-(x-x0)**2/dx125**2)))   
profile125_np=sym.lambdify(xx,profile_125(xx),"numpy")   #In order to evaluate we need to switch to numpy
...
ax.plot(ix,profile125_np(ix), color='indigo')#, linestyle='dotted');
ax.plot(ix,profile15_np(ix), 'g')#, linestyle='dashed');
ax.plot(ix,profile2_np(ix), color='magenta')#, linestyle='dotted');
ax.plot(ix,profile3_np(ix), color='goldenrod')#, linestyle='dotted');
ax.plot(ix,profile1e5_np(ix), 'k')#, linestyle='solid');
ax.plot(ix,profile09_np(ix), color='r')#, linestyle='dotted');
...
#plt.savefig("photospheric_slab_density_profiles_modded.png")
...
with open('width2.pickle', 'rb') as f:
    sol_omegas2, sol_ks2, sol_omegas_kink2, sol_ks_kink2 = pickle.load(f)

with open('width15.pickle', 'rb') as f:
    sol_omegas15, sol_ks15, sol_omegas_kink15, sol_ks_kink15 = pickle.load(f)

with open('width125.pickle', 'rb') as f:
    sol_omegas125, sol_ks125, sol_omegas_kink125, sol_ks_kink125 = pickle.load(f)
...
### SORT ARRAYS IN ORDER OF wavenumber ###
sol_omegas2 = [x for _,x in sorted(zip(sol_ks2,sol_omegas2))]
sol_ks2 = np.sort(sol_ks2)

sol_omegas2 = np.array(sol_omegas2)
sol_ks2 = np.array(sol_ks2)

sol_omegas_kink2 = [x for _,x in sorted(zip(sol_ks_kink2,sol_omegas_kink2))]
sol_ks_kink2 = np.sort(sol_ks_kink2)

sol_omegas_kink2 = np.array(sol_omegas_kink2)
sol_ks_kink2 = np.array(sol_ks_kink2)
...
### SORT ARRAYS IN ORDER OF wavenumber ###
sol_omegas125 = [x for _,x in sorted(zip(sol_ks125,sol_omegas125))]
sol_ks125 = np.sort(sol_ks125)

sol_omegas125 = np.array(sol_omegas125)
sol_ks125 = np.array(sol_ks125)

sol_omegas_kink125 = [x for _,x in sorted(zip(sol_ks_kink125,sol_omegas_kink125))]
sol_ks_kink125 = np.sort(sol_ks_kink125)

sol_omegas_kink125 = np.array(sol_omegas_kink125)
sol_ks_kink125 = np.array(sol_ks_kink125)
...
ax.plot(sol_ks2, (sol_omegas2/sol_ks2), color='magenta', marker='.', linestyle='', markersize=4.)
ax.plot(sol_ks15, (sol_omegas15/sol_ks15), 'g.', markersize=4.)
ax.plot(sol_ks125, (sol_omegas125/sol_ks125), color='indigo', marker='.', linestyle='', markersize=4.)
...
#ax.plot(sol_ks_kink2, (sol_omegas_kink2/sol_ks_kink2), color='magenta', marker='.', linestyle='', markersize=4.)
#ax.plot(sol_ks_kink15, (sol_omegas_kink15/sol_ks_kink15), 'g.', markersize=4.)
#ax.plot(sol_ks_kink125, (sol_omegas_kink125/sol_ks_kink125), color='indigo', marker='.', linestyle='', markersize=4.)
...
ax2.plot(sol_ks2, (sol_omegas2/sol_ks2), color='magenta', marker='.', linestyle='', markersize=4.)
ax2.plot(sol_ks15, (sol_omegas15/sol_ks15), 'g.', markersize=4.)
ax2.plot(sol_ks125, (sol_omegas125/sol_ks125), color='indigo', marker='.', linestyle='', markersize=4.)
...
#ax2.plot(sol_ks_kink2, (sol_omegas_kink2/sol_ks_kink2), color='magenta', marker='.', linestyle='', markersize=4.)
#ax2.plot(sol_ks_kink15, (sol_omegas_kink15/sol_ks_kink15), 'g.', markersize=4.)
#ax2.plot(sol_ks_kink125, (sol_omegas_kink125/sol_ks_kink125), color='indigo', marker='.', linestyle='', markersize=4.)
...
for i in range(len(sol_ks_kink1e5)):
    ...
    if sol_ks_kink1e5[i] > 2.9 and sol_ks_kink1e5[i] < 2.925:  
...
for i in range(len(sol_ks_kink3)):
    ...
    if sol_ks_kink3[i] > 2.9 and sol_ks_kink3[i] < 2.925:    
       if sol_omegas_kink3[i]/sol_ks_kink3[i] < 1. and sol_omegas_kink3[i]/sol_ks_kink3[i] > 0.9: 
...
########
sol_ks2_singleplot_fast = []
sol_omegas2_singleplot_fast = []
sol_ks2_singleplot_slow = []
sol_omegas2_singleplot_slow = []

sol_ks2_singleplot_fast_kink = []
sol_omegas2_singleplot_fast_kink = []
sol_ks2_singleplot_slow_kink = []
sol_omegas2_singleplot_slow_kink = []


for i in range(len(sol_ks2)):
    if sol_ks2[i] > 2.025 and sol_ks2[i] < 2.075:
      if sol_omegas2[i]/sol_ks2[i] > 1.1:
        sol_ks2_singleplot_fast.append(sol_ks2[i])
        sol_omegas2_singleplot_fast.append(sol_omegas2[i])
        
    if sol_ks2[i] > 2.625 and sol_ks2[i] < 2.675:  
      if sol_omegas2[i]/sol_ks2[i] < 0.95 and sol_omegas2[i]/sol_ks2[i] > 0.9:
        sol_ks2_singleplot_slow.append(sol_ks2[i])
        sol_omegas2_singleplot_slow.append(sol_omegas2[i])    

for i in range(len(sol_ks_kink2)):
    if sol_ks_kink2[i] > 2.025 and sol_ks_kink2[i] < 2.075:        
       if sol_omegas_kink2[i]/sol_ks_kink2[i] > 1.:
         sol_ks2_singleplot_fast_kink.append(sol_ks_kink2[i])
         sol_omegas2_singleplot_fast_kink.append(sol_omegas_kink2[i])        

    if sol_ks_kink2[i] > 2.9 and sol_ks_kink2[i] < 2.925:    
       if sol_omegas_kink2[i]/sol_ks_kink2[i] < 1. and sol_omegas_kink2[i]/sol_ks_kink2[i] > 0.89: 
         sol_ks2_singleplot_slow_kink.append(sol_ks_kink2[i])
         sol_omegas2_singleplot_slow_kink.append(sol_omegas_kink2[i])
         
         
sol_ks2_singleplot_fast = np.array(sol_ks2_singleplot_fast)
sol_omegas2_singleplot_fast = np.array(sol_omegas2_singleplot_fast)    
sol_ks2_singleplot_slow = np.array(sol_ks2_singleplot_slow)
sol_omegas2_singleplot_slow = np.array(sol_omegas2_singleplot_slow)    

sol_ks2_singleplot_fast_kink = np.array(sol_ks2_singleplot_fast_kink)
sol_omegas2_singleplot_fast_kink = np.array(sol_omegas2_singleplot_fast_kink)
sol_ks2_singleplot_slow_kink = np.array(sol_ks2_singleplot_slow_kink)
sol_omegas2_singleplot_slow_kink = np.array(sol_omegas2_singleplot_slow_kink)
...
for i in range(len(sol_ks_kink15)):
    ...
    if sol_ks_kink15[i] > 2.9 and sol_ks_kink15[i] < 2.925:  
...
########    
sol_ks125_singleplot_fast = []
sol_omegas125_singleplot_fast = []
sol_ks125_singleplot_slow = []
sol_omegas125_singleplot_slow = []

sol_ks125_singleplot_fast_kink = []
sol_omegas125_singleplot_fast_kink = []
sol_ks125_singleplot_slow_kink = []
sol_omegas125_singleplot_slow_kink = []


for i in range(len(sol_ks125)):
    if sol_ks125[i] > 2.025 and sol_ks125[i] < 2.075:
      if sol_omegas125[i]/sol_ks125[i] > 1.1:
        sol_ks125_singleplot_fast.append(sol_ks125[i])
        sol_omegas125_singleplot_fast.append(sol_omegas125[i])
        
    if sol_ks125[i] > 2.605 and sol_ks125[i] < 2.675:  
      if sol_omegas125[i]/sol_ks125[i] < 0.95 and sol_omegas125[i]/sol_ks125[i] > 0.9: 
        sol_ks125_singleplot_slow.append(sol_ks125[i])
        sol_omegas125_singleplot_slow.append(sol_omegas125[i])    

for i in range(len(sol_ks_kink125)):
    if sol_ks_kink125[i] > 2.025 and sol_ks_kink125[i] < 2.075:        
       if sol_omegas_kink125[i]/sol_ks_kink125[i] > 1.:
         sol_ks125_singleplot_fast_kink.append(sol_ks_kink125[i])
         sol_omegas125_singleplot_fast_kink.append(sol_omegas_kink125[i])        
 
    if sol_ks_kink125[i] > 2.9 and sol_ks_kink125[i] < 2.925:  
      if sol_omegas_kink125[i]/sol_ks_kink125[i] < 0.95 and sol_omegas_kink125[i]/sol_ks_kink125[i] > 0.88:
         sol_ks125_singleplot_slow_kink.append(sol_ks_kink125[i])
         sol_omegas125_singleplot_slow_kink.append(sol_omegas_kink125[i])
         
         
sol_ks125_singleplot_fast = np.array(sol_ks125_singleplot_fast)
sol_omegas125_singleplot_fast = np.array(sol_omegas125_singleplot_fast)    
sol_ks125_singleplot_slow = np.array(sol_ks125_singleplot_slow)
sol_omegas125_singleplot_slow = np.array(sol_omegas125_singleplot_slow)    

sol_ks125_singleplot_fast_kink = np.array(sol_ks125_singleplot_fast_kink)
sol_omegas125_singleplot_fast_kink = np.array(sol_omegas125_singleplot_fast_kink)
sol_ks125_singleplot_slow_kink = np.array(sol_ks125_singleplot_slow_kink)
sol_omegas125_singleplot_slow_kink = np.array(sol_omegas125_singleplot_slow_kink)
...
ax.plot(sol_ks2_singleplot_slow, (sol_omegas2_singleplot_slow/sol_ks2_singleplot_slow), color='magenta', marker='.', linestyle='', markersize=10.)
ax.plot(sol_ks15_singleplot_slow, (sol_omegas15_singleplot_slow/sol_ks15_singleplot_slow), 'g.', markersize=10.)
ax.plot(sol_ks125_singleplot_slow, (sol_omegas125_singleplot_slow/sol_ks125_singleplot_slow), color='indigo', marker='.', linestyle='', markersize=10.)
...
#ax.plot(sol_ks2_singleplot_slow_kink, (sol_omegas2_singleplot_slow_kink/sol_ks2_singleplot_slow_kink), color='magenta', marker='.', linestyle='', markersize=10.)
#ax.plot(sol_ks15_singleplot_slow_kink, (sol_omegas15_singleplot_slow_kink/sol_ks15_singleplot_slow_kink), 'g.', markersize=10.)
#ax.plot(sol_ks125_singleplot_slow_kink, (sol_omegas125_singleplot_slow_kink/sol_ks125_singleplot_slow_kink), color='indigo', marker='.', linestyle='', markersize=10.)
...
wavenum = sol_ks2_singleplot_slow
frequency = sol_omegas2_singleplot_slow
...
normalised_left_P_solution_2 = left_P_solution/np.amax(abs(left_P_solution))    #normalisation_factor_pressure   #
normalised_left_vx_solution_2 = left_solution/np.amax(abs(left_solution))     #normalisation_factor_vx   #
left_bound_vx = left_solution[-1] 
...
normalised_inside_P_solution_2 = inside_P_solution/np.amax(abs(left_P_solution))   #normalisation_factor_pressure   #
normalised_inside_vx_solution_2 = inside_solution/np.amax(abs(left_solution))    #normalisation_factor_vx   #
...
wavenum = sol_ks125_singleplot_slow
frequency = sol_omegas125_singleplot_slow
...
normalised_left_P_solution_125 = left_P_solution/np.amax(abs(left_P_solution))       #normalisation_factor_pressure   #
normalised_left_vx_solution_125 = left_solution/np.amax(abs(left_solution))         #normalisation_factor_vx   #
left_bound_vx = left_solution[-1] 
...
normalised_inside_P_solution_125 = inside_P_solution/np.amax(abs(left_P_solution))      #normalisation_factor_pressure    #
normalised_inside_vx_solution_125 = inside_solution/np.amax(abs(left_solution))       #normalisation_factor_vx     #
...
normalised_left_P_solution_09 = left_P_solution/normalisation_factor_pressure    #np.amax(abs(left_P_solution))     #
normalised_left_vx_solution_09 = left_solution/normalisation_factor_vx   #np.amax(abs(left_solution))      # 
left_bound_vx = left_solution[-1] 
...
normalised_inside_P_solution_09 = inside_P_solution/normalisation_factor_pressure    #np.amax(abs(left_P_solution))      #
normalised_inside_vx_solution_09 = inside_solution/normalisation_factor_vx    #np.amax(abs(left_solution))      #


##################################

wavenum = sol_ks_bess_singleplot_fast
frequency = sol_omegas_bess_singleplot_fast
...
normalised_left_P_solution_bess = left_P_solution/normalisation_factor_pressure    #np.amax(abs(left_P_solution))     #
normalised_left_vx_solution_bess = left_solution/normalisation_factor_vx   #np.amax(abs(left_solution))      # 
left_bound_vx = left_solution[-1] 
...
normalised_inside_P_solution_bess = inside_P_solution/normalisation_factor_pressure    #np.amax(abs(left_P_solution))      #
normalised_inside_vx_solution_bess = inside_solution/normalisation_factor_vx    #np.amax(abs(left_solution))      #
...
ax.plot(lx, normalised_left_P_solution_2, color='magenta')
ax.plot(ix, normalised_inside_P_solution_2, color='magenta')

ax.plot(lx, normalised_left_P_solution_15, 'g')
ax.plot(ix, normalised_inside_P_solution_15, 'g')

ax.plot(lx, normalised_left_P_solution_125, color='indigo')
ax.plot(ix, normalised_inside_P_solution_125, color='indigo')
...
ax2.plot(lx, normalised_left_vx_solution_2, color='magenta')
ax2.plot(ix, normalised_inside_vx_solution_2, color='magenta')

ax2.plot(lx, normalised_left_vx_solution_15, 'g')
ax2.plot(ix, normalised_inside_vx_solution_15, 'g')

ax2.plot(lx, normalised_left_vx_solution_125, color='indigo')
ax2.plot(ix, normalised_inside_vx_solution_125, color='indigo')
...
plt.savefig("photospheric_slab_body_sausage_eigenfunctions_stdnorm_modded.png")
...
if len(sausage_extra_branch2_omega) > 1:
  ...
  ESB3_k_new = np.linspace(ESB3_k[-1], Kmax, num=len(ESB2_k)*10)    #did finish at Kmax other than W=2.5
...
#plt.savefig("photospheric_slab_body_kink_15_full.png")
...
##ax.axvline(x=B, color='r', linestyle='--')
#
##ax.plot(-B, 5, 5, color='r', linestyle='--')
#x1 = [-1, -1, -1, -1]
#y1 = [-1.5, 1.5, 1.5, -1.5]
#z1 = [0, 0, 5, 5]
...
#ax.add_collection3d(Poly3DCollection(verts2, alpha=0.2))
#
#
#
#ax.plot(lx, normalised_left_vx_solution_1e5, 0, zdir='y', color='black')
#ax.plot(ix, normalised_inside_vx_solution_1e5, 0, zdir='y', color='black')
#
#ax.plot(lx, normalised_left_vx_solution_3, 1, zdir='y', color='goldenrod')
#ax.plot(ix, normalised_inside_vx_solution_3, 1, zdir='y', color='goldenrod')
#
#ax.plot(lx, normalised_left_vx_solution_2, 2, zdir='y', color='magenta')
#ax.plot(ix, normalised_inside_vx_solution_2, 2, zdir='y', color='magenta')
#
#ax.plot(lx, normalised_left_vx_solution_15, 3, zdir='y', color='green')
#ax.plot(ix, normalised_inside_vx_solution_15, 3, zdir='y', color='green')
#
#ax.plot(lx, normalised_left_vx_solution_125, 4, zdir='y', color='indigo')
#ax.plot(ix, normalised_inside_vx_solution_125, 4, zdir='y', color='indigo')
#
#ax.plot(lx, normalised_left_vx_solution_09, 5, zdir='y', color='red')
#ax.plot(ix, normalised_inside_vx_solution_09, 5, zdir='y', color='red')
#
#ax.set_xlim(-3.,3.)
##################################################
