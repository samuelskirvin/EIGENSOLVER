...
#sol_omegas1 = np.concatenate((sol_omegas_bess, sol_omegas_bess_zoom), axis=None)
#sol_ks1 = np.concatenate((sol_ks_bess, sol_ks_bess_zoom), axis=None)
#sol_omegas_kink1 = np.concatenate((sol_omegas_kink_bess, sol_omegas_kink_bess_zoom), axis=None)
#sol_ks_kink1 = np.concatenate((sol_ks_kink_bess, sol_ks_kink_bess_zoom), axis=None)
...
ax.annotate( ' $v_{Ae}$', xy=(Kmax, vA_e+0.02), fontsize=20)
...
#plt.savefig("photospheric_curves_dots_shaded_15.png")
